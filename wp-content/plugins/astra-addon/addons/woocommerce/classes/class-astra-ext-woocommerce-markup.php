...
if ( ! class_exists( 'ASTRA_Ext_WooCommerce_Markup' ) ) {
	...
	class ASTRA_Ext_WooCommerce_Markup {
		 ...
		 * @return html
		 */
		function astra_woo_mini_cart_markup( $atts ) {
		 ...
		 * @return void
		 */
		function get_off_canvas_sidebar() {
		 ...
		 * @return void
		 */
		function astra_shop_pagination( $output ) {
		 ...
		 */
		function product_navigation_wrapper_start() {
		 ...
		 */
		function product_navigation_wrapper_end() {
			?>
		...
		function off_canvas_button() {
			...
			switch ( astra_get_option( 'shop-off-canvas-trigger-type' ) ) {
				case 'link':
					echo '<a href="#" class="astra-shop-filter-button" data-selector="astra-off-canvas-sidebar-wrapper"><span class="' . $icon_class . '"></span>' . $filter_text . '</a>';
					break;

				case 'button':
					echo '<button class="button astra-shop-filter-button" data-selector="astra-off-canvas-sidebar-wrapper"><span class="' . $icon_class . '"></span>' . $filter_text . '</button>';
					break;
			}
		}
		 ...
		 * @return void
		 */
		function off_canvas_applied_filters() {
		 ...
		 * @return array;
		 */
		function add_to_cart_args( $defaults, $product ) {
		 ...
		 * @return array;
		 */
		function header_cart_icon_class( $classes ) {
		 ...
		 * @return void;
		 */
		function header_cart_icon_markup() {
		 ...
		 */
		function customization_checkout_page() {
		 ...
		 */
		function customization_cart_page() {
		 ...
		 * Header markup.
		 */
		function checkout_header_markup() {
		 ...
		 * Footer markup.
		 */
		function checkout_footer_markup() {
		 ...
		 * @return string
		 */
		function category_featured_image( $bg_img, $is_override ) {
		 ...
		 * @return array
		 */
		function localize_variables_shop_page( $localize_vars ) {

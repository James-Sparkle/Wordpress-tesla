...
define( 'ELEMENTOR_PRO_VERSION', '2.3.1' );
define( 'ELEMENTOR_PRO_PREVIOUS_STABLE_VERSION', '2.2.5' );
...
function elementor_pro_load_plugin() {
	...
	$elementor_version_required = '2.3.0';
	...
	$elementor_version_recommendation = '2.3.0';
